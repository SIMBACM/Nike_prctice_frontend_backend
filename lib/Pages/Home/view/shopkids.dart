...
class Shopkids extends StatefulWidget {
  const Shopkids({super.key});

  @override
  State<Shopkids> createState() => _ShopkidsState();
}

class _ShopkidsState extends State<Shopkids> {
  @override
  Widget build(BuildContext context) {
    return Consumer<Dasboardprovider>(
      builder: (context, shopkidsmodel, child) => Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    shopkidsmodel.isLoading
                        ? CircularProgressIndicator()
                        : SingleChildScrollView(
                            scrollDirection: Axis.horizontal,
                            child: Row(
                              children: shopkidsmodel.products.map((product) {
                                return productCard(
        ...
        bottomNavigationBar: commonBottomNavigationBar(context, shopkidsmodel),
      ),
    );
  }
}
