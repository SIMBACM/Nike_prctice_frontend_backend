...
class _ShopwomenState extends State<Shopwomen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<Dasboardprovider>(
      builder: (context, shopwomenmodel, child) => Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    shopwomenmodel.isLoading
                        ? CircularProgressIndicator()
                        : SingleChildScrollView(
                            scrollDirection: Axis.horizontal,
                            child: Row(
                              children: shopwomenmodel.products.map((product) {
                                return productCard(
        ...
        bottomNavigationBar: commonBottomNavigationBar(context, shopwomenmodel),
      ),
    );
  }
}
